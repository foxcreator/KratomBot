...
class ClearSuppliesAndStock extends Command
{
    ...
    public function handle()
    {
        ...
        $productOptionsCount = ProductOption::count();
        ...
        $this->table(
            ...
            [
                ...
                ['Опції товарів (ProductOption)', $productOptionsCount],
            ]
        );
        ...
        $this->warn('⚠️  УВАГА! Ця команда видалить:');
        $this->warn('   • Всі поставки постачальників');
        $this->warn('   • Всі елементи поставок');
        ...
        try {
            DB::transaction(function () {
                ...
                $this->info('   ✅ Кількість товарів скинуто');
        ...
        $this->newLine();
        $this->info('🎉 Всі поставки та склад очищено!');
        $this->info('💡 Тепер ви можете створити нові поставки з чистим складом');
