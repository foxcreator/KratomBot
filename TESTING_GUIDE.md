# 🧪 Гід по тестуванню системи EasySale

## 📋 Загальний огляд

EasySale - це комплексна система управління бізнесом, яка включає Telegram бот для клієнтів та адмін-панель для менеджерів. Система автоматизує весь цикл продажів від каталогу товарів до фінансового обліку.
